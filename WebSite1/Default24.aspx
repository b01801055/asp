<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="Default24.aspx.cs" Inherits="Default24" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="id" DataSourceID="SqlDataSource1" GroupItemCount="5" OnItemCommand="ListView1_ItemCommand">
                <AlternatingItemTemplate>
                    <td runat="server" style="background-color: #FFFFFF;color: #284775;">id:
                        ...
                        <br /><br />title:
                        <asp:Label ID="titleLabel" runat="server" ForeColor="Yellow" style="font-size: large" Text='<%# Eval("title") %>' />
                        <br /><br />
...
<td runat="server" />
                ...
                <ItemTemplate>
                    <td runat="server" style="background-color: #E0FFFF; color: #333333;">id:
                        ...
                        <asp:Label ID="test_timeLabel" runat="server" Text='<%# Eval("test_time") %>' />
                        <br /><br />title:
                        <asp:Label ID="titleLabel" runat="server" style="font-size: large" Text='<%# Eval("title") %>' />
                        <br /><br /><br />
                        <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="刪除" />
                        <br />
                        <asp:Button ID="EditButton" runat="server" CommandName="Edit" Text="編輯" />
                ...
                <SelectedItemTemplate>
                    <td runat="server" style="background-color: #E2DED6;font-weight: bold;color: #333333;">id:
                        ...
                        <br />
                        <asp:Button ID="EditButton" runat="server" CommandName="Edit" Text="編輯" />
                        <asp:Button ID="Button3" runat="server" CommandName="Noselect" Text="Button_NOselect" />
                        <br /></td>
                </SelectedItemTemplate>
            </asp:ListView>
