<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Food_Menu_2.aspx.cs" Inherits="Book_Sample_B06_DataBinding_Food_Menu_Food_Menu_2" %>
...
<body>
    ...
    <p>
        點選食物種類，就會出現相關的菜名：</p>
    <p>
        <span class="style1">（修正版，自己寫程式控制 DataBinding）</span></p>
    ...
    <div>
        ...
        <asp:ListBox ID="ListBox1" runat="server" AutoPostBack="True" 
            DataTextField="food_name" DataValueField="food_name" OnSelectedIndexChanged="ListBox1_SelectedIndexChanged"></asp:ListBox>（請使用 AutoPostBack）
