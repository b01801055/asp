...
public partial class DataReader_Parameter : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try   {
            ...
            String SQLstr = "select top 5 id, test_time, title, summary from test with(nolock) where title LIKE '%' + @title + '%' and summary LIKE '%' + @summary + '%'";
    ...
    /// <summary>
    /// 把 「SQL指令＋多個參數」在此執行，並傳回一個 DataReader
    /// </summary>
    /// <param name="conn">DB連結字串</param>
    /// <param name="sqlstr">T-SQL指令</param>
    /// <param name="paralist">參數的 List</param>
    /// <returns>傳回一個 SqlDataReader</returns>
