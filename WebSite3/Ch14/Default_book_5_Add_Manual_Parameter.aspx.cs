...
public partial class Ch14_Default_book_5_Add_Manual_Parameter : System.Web.UI.Page
{
    protected void myDBInit()
    {
        ...
        SqlDataSource SqlDataSource1 = new SqlDataSource
        {
            ...
            ConnectionString = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["testConnectionString"].ConnectionString,

            //== 撰寫SQL指令 ==
            SelectCommand = "SELECT * FROM [test] order by id DESC",
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        #region  //== 改用參數 (InsertParameters)來進行輸入！ ==
