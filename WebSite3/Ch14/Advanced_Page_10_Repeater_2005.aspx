<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Advanced_Page_10_Repeater_2005.aspx.cs" Inherits="Advanced_Page_10_Repeater" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>自己手寫版的分頁程式 -- Repeater (2005)</title>
    <style type="text/css">
        .style2  {
            color: #FF0000;
            font-weight: bold;
...
<body>
    ...
    <div>
        <p>自己手寫版的分頁程式&nbsp; <span class="style2">DataReader</span>  + <span class="style1">SQL 2005指令的Row_NUMBER</span>（後置程式碼）
        </p>
        <div>
