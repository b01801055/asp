...
public partial class Ch17_File_DataSet_XML_1 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter myAdapter = new SqlDataAdapter("select id,test_time,title,author from test with(nolock)", Conn);
        ...
        try
        {
            ...
            FileStream fs = new FileStream("c:\\temp\\mis2000lab_test.xml", FileMode.Create);
            // 可以執行這段SQL指令來成生XML內容。SELECT id, test_time, title, author FROM test FOR XML AUTO
        ...
        Label1.Text = "<font color=red>資料轉換成功！....請看看電腦 C:\\Temp\\ 底下的 mis2000lab_test.xml檔案</font>";
    }
}
