...
//=======================
using System.Text;  //自己寫的（宣告）。StringBuilder會用到。
...
public partial class Ch16_Case_2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack == false)
        {
            ...
            //====歡迎新夥伴加入====
            Application.Lock();   //***** (start)
            
            StringBuilder my_Label = new StringBuilder();   // 搭配 System.Text命名空間
            for (int i = 15; i > 0; i--)
            {
    ...
    {   //====列出「目前」聊天室的所有談話內容====
        StringBuilder chatroom = new StringBuilder();   // 搭配 System.Text命名空間
