<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListView_CSS_02_RWD.aspx.cs" Inherits="Book_Sample_Ch12_ListView_ListView_CSS_02" %>
...
<body>
    ...
    <div>
        ...
        沿用 GridView範例（Default_book_GridView_Light_7_Bootstrap.aspx）<br />
        <br />
        ListView搭配RWD (Bootstrap)<br />
        <br />
        <br />
