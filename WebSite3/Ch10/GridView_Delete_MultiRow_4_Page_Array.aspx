<%@ Page Language="C#" debug="true" AutoEventWireup="true" CodeFile="GridView_Delete_MultiRow_4_Page_Array.aspx.cs" Inherits="Book_Sample_Ch10_GridView_Delete_MultiRow_4_Page" %>
...
<head id="Head1" runat="server">
    ...
    <title>批次刪除多筆資料 #4 （分頁，改用「陣列 or List」來記錄被刪除的文章編號））</title>
    <style type="text/css">
        .style1
        {
            color: #009900;
...
<body>
    ...
    <p>
        批次刪除&nbsp; 多筆資料&nbsp;&nbsp; #4<strong><span class="style1">（分頁，改用「陣列 or List」來記錄被刪除的文章編號）</span></strong></p>
    <p>
        &nbsp;</p>
    <p>
        <br />
