<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CS_Page_SQL2012.aspx.cs" Inherits="CS" %>
    ...
    <script type="text/javascript">
        ...
        function GetRecords() {
            ...
            if (pageIndex == 2 || pageIndex <= pageCount) {
                ...
                $.ajax({
                    type: "POST",
                    url: "CS_Page_SQL2012.aspx/GetCustomers",     // *** 記得修改檔名 ***
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <table id="MIS2000Lab" border="1" style="width: 280px; height: 100px;
                        ...
                        <tr>
                            <td>
                                <b>城市: </b><span class="city"><%# Eval("City") %></span><br />
